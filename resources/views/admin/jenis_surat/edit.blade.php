...
<head>
    ...
    <title>Edit Jenis Surat | Volt Dashboard</title>
            ...
            <div class="container mt-4">
                ...
                <div class="card shadow border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.jenis-surat.update', $surat->jenis_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kode" class="form-control" 
                                        value="{{ old('kode', $surat->kode) }}" required>
                                    @error('kode')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_jenis" class="form-control" 
                                        value="{{ old('nama_jenis', $surat->nama_jenis) }}" required>
                                    @error('nama_jenis')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="syarat_json" class="form-control" rows="4" 
                                    placeholder='Contoh: ["KTP", "KK", "Surat Pengantar RT"]'>{{ old('syarat_json', $surat->syarat_json) }}</textarea>
                                @error('syarat_json')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                                <div class="form-text">
