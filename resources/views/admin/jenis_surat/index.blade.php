...
<head>
    ...
    <title>Data Jenis Surat - Volt Dashboard</title>
            ...
            <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ asset('assets-admin/img/team/profile-picture-3.jpg') }}" class="card-img-top rounded-circle border-white" alt="User Avatar">
                    </div>
                    <div class="d-block">
    ...
    <main class="content">
        ...
        <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
            <div class="container-fluid px-0">
                <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-icon-only d-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                ...
                <div>
                    <a href="{{ route('admin.jenis-surat.create') }}" class="btn btn-success text-white">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="table-jenis-surat" class="table table-centered table-nowrap mb-0 rounded">
                                <thead class="thead-light">
                                    <tr>
                                        <th class="border-0">#</th>
                                        <th class="border-0">KODE</th>
                                        <th class="border-0">NAMA JENIS</th>
                                        <th class="border-0">SYARAT</th>
                                ...
                                <tbody>
                                    @forelse ($surats as $s)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.jenis-surat.edit', $s->jenis_id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                <form action="{{ route('admin.jenis-surat.destroy', $s->jenis_id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-3">
                                                <em>Tidak ada data jenis surat.</em>
                                                <br>
                                                <a href="{{ route('admin.jenis-surat.create') }}" class="btn btn-sm btn-success mt-2">Tambah Jenis Surat</a>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
