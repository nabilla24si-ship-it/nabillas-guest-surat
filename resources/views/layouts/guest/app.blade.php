...
<head>
    <meta charset="utf-8">
    <title>Layanan Mandiri Desa - @yield('title', 'Beranda')</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="layanan mandiri, surat desa, administrasi desa" name="keywords">
    <meta content="Layanan pengajuan surat keterangan secara online untuk warga desa" name="description">
...
<body>
    ...
    <!-- Brand & Contact Start -->
    @include('layouts.guest.brand-contact')
    <!-- Brand & Contact End -->
